    ...
    <>
      ...
      <div className="maindiv">
        ...
        <h1 className="productHeading">
          MEN PRODUCTS<span className="totalProductsCount"></span>
        </h1>
        ...
        <div className="buttonsDiv">
          ...
          <select
            ...
            id="priceFilter"
            onClick={(e) => {
              showSortFilter(womens, e);
            }}
            className="filterButtons"
          >
            <option value="default">PRICE</option>
            <option value="low" className="filterButtons">
              (Low - High)
            </option>
            <option value="high" className="filterButtons">
              (High - Low)
            </option>
          </select>
                ...
                <div>
                  <Link to={`/details/${e.id}`}>
                    <div
                      ...
                      onMouseOver={() => change(e)}
                    >
                      {<img src={e.gallary[1]} alt="demo" />}
                    </div>
                    <div>{e.price}</div>
